...
console.log("\n");
console.log("Expected output of findLongestWord([okay,Narouz,vowel]) is 5 " + myFunctionTest(5, () => findLongestWord("okay", "Narouz", "vowel")));
console.log("Expected output of findLongestWord([okay,Narouz,vowel]) is 5 " + myFunctionTest(3, () => findLongestWord("okay", "Narouz", "vowel")));

console.log("\n");
console.log("Expected output of filterLongWords(4,[okay,Narouz,vowel]) is [Narouz,vowel] " + myFunctionArrayTest(['Narouz', 'vowel'], () => filterLongWords(4, 'okay', 'Narouz', 'vowel')));
console.log("Expected output of filterLongWords(4,[okay,Narouz,vowel]) is [Narouz,vowel] " + myFunctionArrayTest(['Narouz'], () => filterLongWords(4, 'okay', 'Narouz', 'vowel')));
