...
let teacher1 = new Teacher("Narouz", 30);
console.log(teacher1.teach("WAP"));

let teacher2 = new Teacher("Narouz", 30)
...
console.log("Teacher Test - tech() method: " + myFunctionTest("Narouz is now teaching WAP", () => new Teacher("Narouz", 30).teach("WAP")));
console.log("Teacher Test - describe() method: " + myFunctionTest("Greetings, my name is Narouz and I am 30 years old.", () => new Teacher("Narouz", 30).describe()));